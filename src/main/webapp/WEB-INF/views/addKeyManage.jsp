...
<html>
<body>
	<form action="keyManageAdd" method="post" name="form">
		<div style="text-align: right">

			<table class="board_view">
				<caption>
					<font size="5"> <b> キーマネージ 追加 </b>
					</font>
				</caption>
				<tbody>
					<tr>
						...
						<td>
							<select id="raspberrypimac" name="raspberrypimac"  style="width: 100%;">
								<c:forEach items="${manageList}" var="dto"> <option value="${dto.raspberrypimac}">${dto.raspberrypimac}   ( ${dto.name} ) </option></c:forEach>
							</select> 
						</td>
					</tr>
					<tr>
